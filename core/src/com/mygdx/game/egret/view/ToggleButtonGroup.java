...
public class ToggleButtonGroup<T extends ToggleButton> {
    ...
    public ToggleButtonGroup(T... buttons) {
        minCheckCount = 0;
        minCheckCount = 1;
    ...
    public static void make(ToggleButton... buttons){
        ToggleButtonGroup checkBoxGroup = new ToggleButtonGroup<>();
